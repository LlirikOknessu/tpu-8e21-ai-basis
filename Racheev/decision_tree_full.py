...
TREES_MODELS_BEST_PARAMETERS = {
    'DecisionTree': {'max_depth': 7, 'min_samples_leaf': 3, 'min_samples_split': 3, 'splitter': 'best'},
    'RandomForest': {'max_depth': 7, 'min_samples_leaf': 3, 'min_samples_split': 6, 'n_estimators': 15},
    'ExtraTree': {'max_depth': 7, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 15}}
